...
export default function Slider(props){
  ...
  return(
    ...
    <button type="button" className={styles.buttonPrev+ " " +styles.btn} onClick={handleChangeImagePrev}><NavigateBeforeIcon className={styles.icon}/></button>
    <button type="button" className={styles.buttonNext+ " " +styles.btn} onClick={handleChangeImageNext}><NavigateNextIcon className={styles.icon}/></button>
